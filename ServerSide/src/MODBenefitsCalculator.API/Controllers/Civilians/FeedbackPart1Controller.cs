...
namespace MODBenefitsCalculator.API.Controllers.Civilians
{
    ...
    [ApiController]
    [Route("api/civ/feedback/initial")]
    public class FeedbackPart1Controller : ControllerBase
    {
        ...
        /// <summary>
        /// [CIVILIANS] Saves the initial feedback response with additional meta data from the user's session and browser state
        /// </summary>
        /// <remarks>
        /// Sample request:
        /// 
        ///     POST /api/civ/feedback/initial
        ///     {
