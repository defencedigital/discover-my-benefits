...
using MODBenefitsCalculator.API.Models.Civilians.Feedback;
...
namespace MODBenefitsCalculator.API.Controllers.Civilians
{
    [Produces("application/json")]
    [ApiController]
    [Route("api/civ/feedback/final")]
    public class FeedbackPart2Controller : ControllerBase
    {
        ...
        /// <summary>
        /// [CIVILIANS] Saves the key feedback information provided by the user. This is appended to the previous data the user sent.
        /// </summary>
        /// <remarks>
        /// Sample request:
        /// 
        ///     POST /api/civ/feedback/final
        ///     {
        ...
        public ActionResult<FeedbackPart2ResponseDTO> Post(FeedbackPart2RequestDTO feedback)
        {
            ...
            var apiResult = _zoHoService.UpdateFeedback(postData, SubmissionType.Civilians);
